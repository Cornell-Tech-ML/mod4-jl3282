...
class Module:
    ...
    def parameters(self) -> Sequence[Parameter]:
        ...
        Returns
        -------
        Sequence[Parameter]: A list of parameters for this module and its descendants.
    ...
    def __call__(self, *args: Any, **kwargs: Any) -> Any:
        """Invoke the forward method with the given arguments.

        Args:
        ----
            *args: Positional arguments to be passed to the forward method.
           **kwargs: Keyword arguments to be passed to the forward method.
